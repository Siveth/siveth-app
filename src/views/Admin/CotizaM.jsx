...
import ReplyModal from "../../Componentes/ui/modales/ReplyModa"; // Corregido el nombre del componente
...
const cotizacionesPaginadas = cotizaciones.slice(indexOfFirstItem, indexOfLastItem);
  ...
  const reloadData = async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://back-end-siveth-g8vc.vercel.app/api/cotizacionesMudanza");
    ...
    const fetchCotizaciones = async () => {
      ...
      try {
        ...
        if (currentPage && itemsPerPage) {
          response = await axios.get("https://back-end-siveth-g8vc.vercel.app/api/cotizacionesMudanza", {
            params: {
              page: currentPage,
              limit: itemsPerPage
            }
