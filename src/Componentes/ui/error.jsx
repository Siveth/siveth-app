...
const ErrorComponent = () => {
  return (
    <div className="error bg-red-500 rounded-lg p-4 flex items-center justify-start shadow-md">
      ...
      <div className="error__title text-white font-medium">Lorem ipsum dolor sit amet</div>
      <div className="error__close ml-auto cursor-pointer">
